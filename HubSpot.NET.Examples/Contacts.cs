...
namespace HubSpot.NET.Examples
{
    public class Contacts
    {
        public static async Task Example(HubSpotApi api, CancellationToken cancellationToken = default)
        {
            ...
            await api.Contact.UpdateAsync(contact, cancellationToken);
            ...
            var uploaded = await api.File.UploadAsync(file, cancellationToken);
             ...
             * Delete a contact
             */
            await api.Contact.DeleteAsync(contact.Id.Value, cancellationToken);
            ...
            var contacts = await api.Contact.ListAsync(
                new ListRequestOptions { PropertiesToInclude = new List<string> { "firstname", "lastname", "email" } }, cancellationToken);
